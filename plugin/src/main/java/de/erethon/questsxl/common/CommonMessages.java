...
public class CommonMessages {
    ...
    public CommonMessages() {
        ...
        registerMessage("explorable.discovered", Locale.ENGLISH, "<purple>You discovered <arg:0>!");
        registerMessage("explorable.discovered", Locale.GERMAN, "<purple>Du hast <arg:0><purple>entdeckt!");
        registerMessage("explorationset.completed", Locale.ENGLISH, "<purple>You completed <arg:0>!");
        registerMessage("explorationset.completed", Locale.GERMAN, "<purple>Du hast <arg:0> <purple>abgeschlossen!");
