package de.erethon.questsxl.livingworld.interaction;
...
public class WorldInteraction implements ObjectiveHolder, QComponent {
     ...
     */
    public WorldInteraction(String id, ConfigurationSection section, String source) {
        this.id = id;
        this.source = source;
        load(section);
    }
    ...
    private void load(ConfigurationSection section) {
        ...
        objectives.addAll((Collection<? extends QObjective>) QConfigLoader.load(
                this, "objectives", section, QRegistries.OBJECTIVES, source));
